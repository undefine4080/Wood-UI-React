...
const navList: navList = {
    ...
    common: [
        ...
        { path: 'pagination', label: 'Pagination 分页', element: <IntroPagination /> },
        { path: 'image', label: 'Image 图片', element: <IntroImage /> },
        { path: 'progress', label: 'Progress 进度条', element: <IntroProgress /> },
        { path: 'tag', label: 'Tag 标签', element: <IntroTag /> },
    ],
    content: [
        { path: 'collapse', label: 'Collapse 抽屉', element: <IntroCollapse /> },
        { path: 'navMenu', label: 'NavMenu 导航菜单', element: <IntroNavMenu /> },
        ...
        { path: 'carousel', label: 'Carousel 轮播', element: <IntroCarousel /> },
    ...
    form: [
        ...
        { path: 'checkbox', label: 'Checkbox 多选', element: <IntroCheckbox /> },
        ...
        { path: 'datepicker', label: 'DatePicker 日期选择器', element: undefined },
    ],
    modal: [
        { path: 'modal', label: 'Modal 模态框', element: <IntroModal /> },
        { path: 'message', label: 'Message 消息', element: <IntroMessage /> },
        { path: 'tooltip', label: 'Tooltips 文字提示', element: <IntroTooltip /> },
...
const renderLinks = (targets: navListItem) => {
    const result = targets.map(target => {
        return (
            <NavMenuItem key={target.path} disabled={target.element ? false : true}>
                <Link
                    to={`/${target.path}`}
                >{target.label}</Link>
            </NavMenuItem>
